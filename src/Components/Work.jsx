  ...
  return (
    <section className="px-4 md:px-6 lg:px-8 max-w-[1800px] mx-auto my-6">
      <div className="flex flex-wrap justify-center gap-4 content-container lg:w-auto">
        ...
        <div className="flex gap-4 flex-col md:flex-row lg:flex-col w-full mt-4 md:mt-0 lg:w-[390px]">
          {/* First bottom card */}
          <div className="w-full md:w-[48%] lg:w-full h-[212px] mb-4 md:mb-0">
            <HoverCard
              imageUrl={frame2}
          ...
          {/* Second bottom card */}
          <div className="w-full md:w-[48%] lg:w-full h-[212px]">
            <HoverCard
              imageUrl={frame1}
